...
//get the link element
  ...
  xmlhttp.onloadend = function(e) {
    ...
    // immediately switch to modal display view
    link.href = "https://shrouded-ablaze-pie.glitch.me/display.html?id="+response;
    link.textContent = "https://shrouded-ablaze-pie.glitch.me/display.html?id="+response;
...
document.querySelector('#imgUpload').addEventListener('change', () => {
    ...
    xhr.onloadend = function(e) {
        ...
        newImage.src = "http://ecs162.org:3000/images/mahalbutogullari/"+selectedFile.name;
